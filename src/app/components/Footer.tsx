    ...
    <footer className="footer-main" style={{ backgroundColor: transparent ? "transparent" : "#030303", color: transparent ? "var(--color-text-dark)" : "#ffffff" }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        .bottom-aura {
          ...
          width: 1100px;
          height: 450px;
          background: radial-gradient(circle, rgba(198, 154, 91, 0.15) 0%, rgba(255, 255, 255, 0.02) 60%, transparent 100%);
        ...
        .newsletter-form-glow {
          ...
          background: linear-gradient(90deg, rgba(254,243,199,0.3) 0%, rgba(254,240,138,0.2) 50%, rgba(255,255,255,0.15) 100%);
        ...
        .newsletter-form-wrapper:hover .newsletter-form-glow {
          opacity: 0.8;
        }
        ...
        .country-pill:hover {
          background: rgba(198, 154, 91, 0.1);
          border-color: rgba(198, 154, 91, 0.3);
          color: #FEF3C7;
        }
        
        .country-pill-hq {
          padding: 0.35rem 0.75rem;
          background: linear-gradient(90deg, rgba(198, 154, 91, 0.2) 0%, rgba(198, 154, 91, 0.1) 100%);
        ...
        <div className="footer-top">
          <div className="footer-brand-section">
            <div className="footer-logo-row">
              <Link href="/">
                <Image src="/logo.png" alt="Kinetic Code Labs" width={140} height={40} className="footer-logo" />
              </Link>
            ...
            <p className="footer-description">
              We design and develop fast, secure custom websites, mobile web applications, and practical AI automation tools. Talk directly with our developers in Kanpur with zero middlemen.
            </p>
          </div>
            ...
            <ul className="col-list">
              ...
              <li>
                <span style={{ color: "#9CA3AF", fontSize: "0.8rem", lineHeight: "1.5" }}>
                  Headquarters: Yashoda Nagar, Kanpur, Uttar Pradesh, India (208011)
                </span>
              </li>
        ...
        <div className="footer-bottom">
          ...
          <div className="socials-row">
            ...
            <a aria-label="X (Twitter)" href="https://x.com/yadavajit_spy" target="_blank" rel="noreferrer" className="social-btn">
              <svg style={{ width: "16px", height: "16px" }} fill="currentColor" viewBox="0 0 24 24"><path d="M18.901 1.153h3.68l-8.04 9.19L24 22.846h-7.406l-5.8-7.584-6.638 7.584H.474l8.6-9.83L0 1.154h7.594l5.243 6.932 6.064-6.932zm-1.294 19.497h2.039L5.77 3.087H3.582l14.025 17.563z"/></svg>
            </a>
